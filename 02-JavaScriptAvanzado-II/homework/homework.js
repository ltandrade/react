...
function cacheFunction(cb) {
  ...
  ///// hay que guardar, el numero q le pasamos y el resultado de cb()
  ...
  ///// evaluar si el numero ya se lo habiamos pasado
...
/*Guardar en las siguientes tres variables una función que devuelva una cadena utilizando la 
/función "crearCadena"
y el delimitador especificado. La idea es realizarlo con la función bind para poder volver a 
